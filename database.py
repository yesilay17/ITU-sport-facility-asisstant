...
class Database:
    ...
    def get_user(self):
        mycursor.execute("SELECT * FROM heroku_263577567345e1f.user_ Where userid=%d" %(int(self.__userid)))
    ...
    def get_gym_registration(self):
        mycursor.execute("SELECT * FROM heroku_263577567345e1f.gym Where userid=%d" %(int(self.__userid)))
        data=mycursor.fetchall()
        userid=-1
        for row in data:
            gymid=row[0]
    ...
    def get_carpet_registration(self):
        mycursor.execute("SELECT * FROM heroku_263577567345e1f.carpet Where userid=%d" %(int(self.__userid)))
        data=mycursor.fetchall()
        userid=-1
        for row in data:
            carpetid=row[0]
    ...
    def get_pool_registration(self):
        mycursor.execute("SELECT * FROM heroku_263577567345e1f.pool Where userid=%d" %(int(self.__userid)))
        data=mycursor.fetchall()
        userid=-1
        for row in data:
            poolid=row[0]
    ...
    def get_tennis_registration(self):
        mycursor.execute("SELECT * FROM heroku_263577567345e1f.tennis Where userid=%d" %(int(self.__userid)))
        data=mycursor.fetchall()
        userid=-1
        for row in data:
            tennisid=row[0]
