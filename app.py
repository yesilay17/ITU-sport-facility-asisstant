...
app.add_url_rule("/all_tennis_res_numbers", view_func=views.all_tennis_res_numbers)
app.add_url_rule("/all_carpet_res_numbers", view_func=views.all_carpet_res_numbers)
